...
# p, = ax.plot(dfFT.Height, fitEquationFT, "--",color="red")
p, = ax.plot(dfFT.Height, dfFT.FT, color="blue", marker="o")

p1, = ax.plot(dfFG.Height, dfFG.FG, color="orange", marker="o")
# p1, = ax.plot(dfFG.Height, fitEquationFG, "--",color="red")

p2, = ax.plot(df3PT.Height, df3PT.THREE, color="green", marker="o")
# p2, = ax.plot(df3PT.Height, fitEquation3PT, "--",color="red")

# p3, = ax.plot(dfFT.Height, fitEquationFT, dfFG.Height, fitEquationFG, "--", colour = "red")
